  ...
  switch (api_name) {
    case "legal_entity": {
      ...
      if (initial_execute) {
        ...
        } while (hvac_tables_responses["legal_entity"]["status"] != "success");
    ...
    case "business_unit": {
      ...
      if (final_data_pool.length > 0) {
        ...
        } while (hvac_tables_responses["business_unit"]["status"] != "success");
    ...
    case "campaigns": {
      ...
      Object.keys(data_pool).map((record_id) => {
        ...
        if (record["modifiedOn"]) {
          if (
            new Date(record["modifiedOn"]) > new Date("2000-01-01T00:00:00.00Z")
          ) {
        ...
        if (record["category"]) {
          category_id = record["category"]["id"] ? record["category"]["id"] : 0;
      ...
      Object.keys(telecom_calls_data_pool).map((record_id) => {
        ...
        if (record["leadCall"]["customer"]) {
          ...
          customer_name = record["leadCall"]["customer"]["name"]
            ...
            : "default";
          is_customer_active = record["leadCall"]["customer"]["active"] ? 1 : 0;
        ...
        if (record["leadCall"]["campaign"]) {
          if (record["leadCall"]["campaign"]["createdOn"]) {
            if (
              ...
              campaign_createdOn = record["leadCall"]["campaign"]["createdOn"];
            }
          } else {
          ...
          campaign_name = record["leadCall"]["campaign"]["name"]
            ...
            : "default";
          is_campaign_active = record["leadCall"]["campaign"]["active"] ? 1 : 0;
        }
      ...
      Object.keys(data_pool).map((record_id) => {
        ...
        final_data_pool.push({
          ...
          state: record["address"]["state"]
            ? record["address"]["state"]
            : "default",
          zip: record["address"]["zip"] ? record["address"]["zip"] : "default",
    ...
    case "appointments": {
      ...
      Object.keys(data_pool).map((record_id) => {
        ...
        if (record["start"]) {
          if (new Date(record["start"]) > new Date("2000-01-01T00:00:00.00Z")) {
            start = record["start"];
          }
        } else {
      ...
      if (final_data_pool.length > 0) {
        ...
        } while (hvac_tables_responses["appointments"]["status"] != "success");
    ...
    case "sales_details": {
      ...
      if (final_data_pool.length > 0) {
        ...
        } while (hvac_tables_responses["sales_details"]["status"] != "success");
    ...
    case "invoice": {
          ...
          record["items"].map((items_record) => {
            ...
            if (items_record["type"] == "Material") {
              ...
              cogs_material_final_data_pool.push({
                ...
                generalLedgerAccountdetailType: generalLedgerAccountdetailType,
                job_details_id: job_details_id,
                actual_job_details_id: actual_job_details_id,
      ...
      console.log("cogs_material data: ", cogs_material_final_data_pool.length);
      if (cogs_material_final_data_pool.length > 0) {
        ...
        } while (hvac_tables_responses["cogs_material"]["status"] != "success");
      ...
      console.log("cogs_service data: ", cogs_services_final_data_pool.length);
      if (cogs_services_final_data_pool.length > 0) {
        ...
        } while (hvac_tables_responses["cogs_service"]["status"] != "success");
      ...
      if (gross_profit_final_data_pool.length > 0) {
        ...
        } while (hvac_tables_responses["gross_profit"]["status"] != "success");
    ...
    case "purchase_order": {
      ...
      Object.keys(purchase_order_data_pool).map((record_id) => {
        ...
        if (record["requiredOn"]) {
          if (
            new Date(record["requiredOn"]) > new Date("2000-01-01T00:00:00.00Z")
          ) {
        ...
        if (record["receivedOn"]) {
          if (
            new Date(record["receivedOn"]) > new Date("2000-01-01T00:00:00.00Z")
          ) {

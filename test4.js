...
async function starter() {
  ...
  const data_pool =
    data_lake_true["bookings"]["settings__business-units"]["data_pool"];
  const unique_ids = [...new Set(Object.keys(data_pool))];

  console.log("any_ids: ", Object.keys(data_pool));

  Object.keys(data_pool).map((id) => {
    if (id == "108709") {
      console.log("present");
    }
  });
